...
const Newslatter = () => {
  ...
  return (
    ...
    <ToastContainer
      ...
      pauseOnHover
      theme="light" />
      <div className="flex flex-wrap justify-center mt-20 m-5 scale-105">
        <div className="relative text-center space-y-4 min-h-[40vh] md:h-[70vh] lg:min-h-[50rem] flex flex-col justify-center items-center text-gray-800">
          ...
          <div className="flex gap-4 flex-wrap items-center justify-center ">
            ...
            <Button
              ...
              className="text-white bg-gray-900 hover:bg-gray-900 border border-gray-500 px-4 py-2">   {subscribed ? 'Subscribed' : 'Subscribe'} </Button>
          </div>
        </div>
      </div>
      </>
